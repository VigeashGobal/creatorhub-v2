    ...
    <div className="min-h-screen p-6" style={{ backgroundColor: '#1A1A2E' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="text-center mb-6">
          <div className="text-display text-white mb-4 text-luxury">83</div>
          ...
          <div className="card-dark p-6 glow-blue">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-impact text-white">294K</div>
          ...
          <div className="card-dark p-6 glow-purple">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-impact text-white">9.2%</div>
          ...
          <div className="card-dark p-6 glow-green">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-impact text-white">2.4M</div>
          ...
          <div className="card-dark p-6 glow-pink">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-impact text-white">8.7K</div>
